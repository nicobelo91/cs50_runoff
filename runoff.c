...
bool vote(int voter, int rank, string name)
{
    // INT VOTER: WHICH N° VOTER IS VOTING
    // WHICH RANK IS BEING INDICATED
    // WHICH CANDIDATE IS BEING CHOSEN
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        if (strcmp(candidates[i].name, name) == 0)
            ...
            //IF FOUND, UPDATE PREFERENCE SO THAT THEY ARE THE VOTER'S RANKED PREFERENCE
        {
